    ...
    <section className="section-padding bg-gradient-to-br from-beige-50 to-beige-100">
      <div className="container-max">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            {funFacts.map((fact, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white rounded-3xl p-6 sm:p-8 text-center hover:shadow-lg transition-all duration-300 hover:scale-105 border border-beige-200"
              >
          ...
          >
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-beige-200 max-w-4xl mx-auto">
