  ...
  return (
    <section id="seeking" className="section-padding gradient-bg">
      <div className="container-max">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {opportunities.map((opp, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/80 backdrop-blur-sm border border-gray-200 hover:border-gray-300 transition-all duration-300 p-8 hover:shadow-lg rounded-2xl"
            >
              <div className="flex items-center space-x-3 mb-6">
                <opp.icon className="w-7 h-7 text-gray-900" />
        ...
        >
          <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Details</h3>
